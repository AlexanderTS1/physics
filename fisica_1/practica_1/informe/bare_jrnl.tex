...
Si escribimos $Re = \displaytyle\frac{v \rho 2 R}{\eta}$ por lo que $F = 6 \pi \rho R v$. Por lo tanto, si la velocidad va creciendo, la fuerza de arrastre va creciendo hasta que se llega a un equilibrio:

$V_{\text{lim}} = \displaystyle\frac{2 R^2 (\rho_{\text{cuerpo}} - \rho_{\text{fluido}}) g}{9 \eta}$
