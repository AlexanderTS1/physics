...
El código Python que implementa los modelos matemáticos así como las rutinas de visualización para la resolución de este ejercicio se adjunta con este informe y además puede ser consultado en el siguiente repositorio online (TODO: enlace a GitHub).

El resto del informe se estructura en las siguientes secciones: Sección 1 ..., Sección 2..., Sección 3...

\section{Hundimiento de un Cuerpo en un Fluido}
...
\subsection{Velocidad y Posición}

\subsection{Velocidad Límite}

\subsection{Variando el Tamaño de la Gota}

\subsection{Variando la Potencia de la Velocidad}
